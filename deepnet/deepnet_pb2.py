...
_OPERATION_OPTIMIZER = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='VI', index=4, number=6,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MPT', index=5, number=7,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UPDOWN', index=6, number=8,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TP', index=7, number=9,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='VI_ACCUM', index=8, number=10,
      options=None,
      type=None),
  ],
  containing_type=None,
